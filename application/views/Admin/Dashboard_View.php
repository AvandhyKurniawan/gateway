<html>
	...
	<meta charset="utf-8" />
        ...
        <title>Data Kandidat | Apartment Gateway</title>
	...
	<body>
					...
					<div class="container-fluid">
						<div class="page-title-box">
							<div class="row align-items-center">
								<div class="col-sm-6">
									<h4 class="page-title">Daftar Peserta Kandidat</h4>
								</div>
								<div class="col-sm-6">
								...
								<div class="card m-b-30">
									<div class="card-body">
										<div class="form-group float-right">
											<a href="<?= base_url('Admin/Dashboard/export_data/hold'); ?>" class="btn btn-md btn-success">Export Data</a>
										</div>
										<div class="table-responsive">
											<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
												...
												<tbody>
													<?php foreach($HOLD_DATA as $arrData): ?>
													<tr>
														...
														<td>
															<button class="btn btn-md btn-warning" onclick='action("<?= md5($arrData["peserta_id"]); ?>")'>Hold</button>
														</td>
													</tr>
													<?php endforeach; ?>
												</tbody>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="row">
							<div class="col-md-6">
								<button type="button" class="btn btn-primary btn-block waves-effect" id="btnApprove"> <i class="fas fa-check"></i> Approve</button>
							</div>
							<div class="col-md-6">
		...
		<script>
			function action(param){
				$("#action").modal("show");
				$("#btnApprove").attr("onclick","approve('"+param+"')");
			...
			function approve(param){
				$.ajax({
					...
					beforeSend : function(){
						$("#btnApprove").html('<i class="fas fa-spinner fa-spin"></i> Mohon Tunggu');
					},
					success : function(response){
						$("#btnApprove").html('<i class="fas fa-check"></i> Approve');
						$.alert({
								theme: 'material',
								type: 'blue',
								icon: 'fas fa-check',
